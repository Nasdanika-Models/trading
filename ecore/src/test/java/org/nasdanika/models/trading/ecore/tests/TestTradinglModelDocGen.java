package org.nasdanika.models.trading.ecore.tests;
...
import org.nasdanika.models.trading.ecore.EcoreGenTradingProcessorsFactory;
 ...
 *
 */
public class TestTradinglModelDocGen {
	
	@Test
	public void testGenerateTradingModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenTradingProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenTradingProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "trading.xmi");
		...
		String siteMapDomain = "https://trading.models.nasdanika.org";		
